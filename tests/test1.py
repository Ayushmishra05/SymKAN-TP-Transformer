...
from preprocess.tokenizersplit import SymbolicQEDTokenizer, reconstruct_expression, validate_expression
df = pd.read_csv(r"QED_data/train_data.csv")
...
string_match, symbolic_match = validate_expression(true_expr, tokens, is_source=False)
